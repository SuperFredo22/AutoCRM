      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-xl font-bold text-white">AutoCRM</span>
          </div>
        ...
        <form onSubmit={handleSubmit} className="bg-[#1e2130] rounded-xl border border-[#2a2d3e] p-6 space-y-4">
          {error && (
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#0f1117] border border-[#2a2d3e] rounded-lg px-3 py-2.5 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 text-sm"
            />
          </div>
